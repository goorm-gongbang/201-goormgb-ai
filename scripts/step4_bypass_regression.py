...
def main() -> int:
    ...
    case1_ok = st1 == 200 and v1.get("success") is False and v1.get("remainingAttempts") == 2
    results.append(
        {
    ...
    # Case 2: third fail should consume retries and block.
    ...
    case2_ok = (
        ...
        and st2b == 200
        and st2c == 200
        and v2a.get("remainingAttempts") == 2
        and v2b.get("success") is False
        and v2b.get("remainingAttempts") == 1
        and v2c.get("success") is False
        and v2c.get("remainingAttempts") == 0
        and st2rt == 200
        and runtime2.get("vqa_last_result") == "BLOCKED"
    )
    results.append(
        {
            "case": "THIRD_FAIL_BLOCKS",
            "ok": case2_ok,
            "status_first_verify": st2a,
            "status_second_verify": st2b,
            "status_third_verify": st2c,
